...
public class ConnectPHP {
    ...
    public void start(){
        ...
        request.setRetryPolicy(new com.android.volley.DefaultRetryPolicy(6000 , com.android.volley.DefaultRetryPolicy.DEFAULT_MAX_RETRIES, com.android.volley.DefaultRetryPolicy.DEFAULT_BACKOFF_MULT));
        queue.cancelAll(TAG);
        queue.add(request);
        //queue.start();
