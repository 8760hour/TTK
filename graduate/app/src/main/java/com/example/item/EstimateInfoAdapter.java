    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, final int i) {
        ...
        switch(type){
            ...
            case ESTIMATE_INFO_PART_ITEM:
                ...
                break;
            case ESTIMATE_INFO_REVIEW_READ:
                final ReviewRHolder rrholder = (ReviewRHolder) holder;
                        ...
                        if(app.getMemberIndex() == rmodel.wid){
                            ...
                            ad.setPositiveButton("수정", new DialogInterface.OnClickListener() {
                                ...
                                public void onClick(DialogInterface dialog, int which) {
                                    ...
                                    rrholder.editphp =
                                    new ConnectPHP("http://gebalnote.pe.kr/review_edit.php", 1, param, new Response.Listener<String>() {
                                        @Override
                                        public void onResponse(String response) {
                                            rrholder.editphp.stop();
                                            try{
                ...
                rrholder.report.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        if(app.getMemberIndex() == rmodel.wid){
                            HashMap<String, String> param = new HashMap<>();
                            param.put("index", rmodel.rID + "");
                            rrholder.deletephp = new ConnectPHP("http://gebalnote.pe.kr/review_delete.php", 1, param, new Response.Listener<String>() {
                                @Override
                                public void onResponse(String response) {
                                    rrholder.deletephp.stop();
                                    try{
                                        JSONObject obj = new JSONObject(response);
                                        if(obj.getBoolean("result")){
                                            //성공적 삭제 메세지
            ...
            case ESTIMATE_INFO_REVIEW_WRITE:
                ...
                rwholder.select.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        rwholder.writephp = new ConnectPHP("http://gebalnote.pe.kr/review_write.php", 1, param, listener, activity);
                        rwholder.writephp.start();
                    }
                });
                break;
        }
